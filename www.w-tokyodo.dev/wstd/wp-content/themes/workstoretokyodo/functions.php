	...
	->page( 'page' )
		...
		->section( 'section', 'Section (Optional)' )
			...
			->field( 'field_text' )
				...
				->description( 'Text Field Description (Before)', 'before' )
				->attr_class( 'class1' )
				->attr_class( 'class2' )
				->option( 'text', 'text' )
					->label( 'Text Label (Default - Left)' )
					->content( 'Content (Default - After)' )
					->description( 'Text Option Description (Default - After)' )
					->description( 'Text Option Description (Before)', 'before' )
					->attr_size( 20 )
					->attr_class( 'text-class' )
			->field( 'field_checkbox' )
				->description( 'Checkbox Field Description (Default - After)' )
				->description( 'Checkbox Field Description (Before)', 'before' )
				->option( 'checkbox', 'checkbox' )
					->label( 'Checkbox Label (Default - Right)' )
					->label( 'Checkbox Label (Left)', 'l' )
					->content( 'Content (Default - After)' )
					->description( 'Checkbox Option Description (Default - After)' )
					->description( 'Checkbox Option Description (Before)', 'before' )
					->attr_class( 'checkbox-class' )
